...
public class OfficesControllerTests : IClassFixture<MongoDbFixture>
{
    ...
    private List<Office> _preparedListOfOffices = new List<Office>()
        {
            new Office()
            {
    ...
    public async Task GetAllOffices_TryToGetAllOfficesWhen3OfficesInDatabase_OkResult()
    {
        ...
        collection.InsertMany(_preparedListOfOffices);
        ...
        var collectionOffices = await result.Content.ReadFromJsonAsync<List<OfficeDetailsDTO>>();

        //Assert
        Assert.True(result.IsSuccessStatusCode);
        Assert.True(collectionOffices.Any());
        Assert.Equal(5, collectionOffices.Count);
    }
    ...
    {
        //Arrange
        var preparedOfficesIds = string.Join(",", _preparedListOfOffices[0].OfficeId, _preparedListOfOffices[3].OfficeId);
        ...
        Assert.Equal(officeFromResponse[0].OfficeId, _preparedListOfOffices[0].OfficeId);
        Assert.Equal(officeFromResponse[1].OfficeId, _preparedListOfOffices[3].OfficeId);
    }
    ...
    {
        //Arrange
        var secondOfficeId = _preparedListOfOffices[1].OfficeId;
        ...
        //Assert
        Assert.True(result.IsSuccessStatusCode);
        Assert.Equal(_preparedListOfOffices[1].OfficeId, officeFromResponse.OfficeId);
        Assert.Equal(_preparedListOfOffices[1].City, officeFromResponse.City);
        Assert.Equal(_preparedListOfOffices[1].Street, officeFromResponse.Street);
        Assert.Equal(_preparedListOfOffices[1].OfficeNumber, officeFromResponse.OfficeNumber);
        Assert.Equal(_preparedListOfOffices[1].HouseNumber, officeFromResponse.HouseNumber);
        Assert.Equal(_preparedListOfOffices[1].RegistryPhoneNumber, officeFromResponse.RegistryPhoneNumber);
        Assert.Equal(_preparedListOfOffices[1].IsActive, officeFromResponse.IsActive);
    }
    ...
    public async Task DeleteOffice_TryDeleteOffice_DeleteResult()
    {
        ...
        Assert.Equal(4, officesCollection.Count);
    }
